...
def setup_middlewares(dp: Dispatcher, session_maker: async_sessionmaker):
    ...
    dp.channel_post.middleware(translator_runner_middleware)
    dp.my_chat_member.middleware(translator_runner_middleware)

    # Callback answer middleware
    dp.callback_query.middleware(CallbackAnswerMiddleware())

    logger.success("[Middlewares] Middlewares setup completed")
